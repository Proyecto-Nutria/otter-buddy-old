...
from otter_buddy.utils.common import pretty_time_format
...
class Meta(commands.Cog):
    ...
    @meta.command(brief='Restarts Otter-Buddy')
    ...
    @meta.command(brief='Kill Otter-Buddy')
    @commands.has_role(constants.OTTER_ADMIN)
    ...
    @meta.command(brief='Is Otter-Buddy up?')
